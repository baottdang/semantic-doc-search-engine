...
from ui.main_area.canvas.imageviewer import ImageViewer
...
class ImageDisplay(QtWidgets.QFrame):
    ...
    def set_image(self, qimage):
        self.image_viewer._set_image(qimage)

    def clear_image(self):
        self.image_viewer._clear_image()
        print("img_display")
    ...
    def update_scale_image(self):
        self.image_viewer.update_scale_image()
...
class ImageQueryDisplay(ImageDisplay):
    ...
    def clear(self):
        """
        Clear the image_viewer if an image is present
        
        :param self: Description
        """
        if not self.image_viewer.is_empty():
            self.set_image(None)
        self.set_path_text("")
        self.set_page_text("")
