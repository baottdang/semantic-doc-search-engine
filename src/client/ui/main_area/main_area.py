...
class MainArea(QtWidgets.QFrame):
    def __init__(self, parent=None):
        ...
        self.query_display.setSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        self.result_display = ImageResultDisplay(self)
        self.result_display.setSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
    ...
    def clear_query(self):
        ...
        self.query_display.set_page_text("")
        self.query_display.clear_image()
        print("clear here")
